...
def run():
    ...
    agent = env.create_agent(LearningAgent,learning=True)#,alpha=.7
    ...
    sim = Simulator(env,update_delay=0.00001,log_metrics=True,display=False) #
